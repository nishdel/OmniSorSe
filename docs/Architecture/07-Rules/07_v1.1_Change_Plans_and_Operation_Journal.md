...
Every returned terminal Apply or Undo journal is projected from actual action
outcomes rather than from the source plan's intent. Successful rename/move
actions retain their Results file ID where safe, obsolete paths leave the Files
projection, duplicate groups and planned-operation indicators are rebuilt, and
