...
| [v2.2.0 Release Notes](RELEASE_NOTES_v2.2.0.md) | Downloads, Media Intelligence/UX changes, trust status, checksums, limitations, and validation boundary. | Before installing or publishing v2.2.0. | Current release snapshot |
