...
The current implementation candidate is v2.11 on top of the linear v2.5–v2.10
release-candidate stack. It targets .NET 10 LTS and changes platform/release
evidence, not product intelligence or mutation authority. v2.4.0 remains the
