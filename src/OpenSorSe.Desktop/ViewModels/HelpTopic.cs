...
public static class HelpCatalog
{
    ...
    [
        ...
        Topic(HelpTopicId.SemanticSearch, "Search", "Hybrid Search finds known files using names, folder names, metadata, document text, OCR, local topics, textual entities, summaries, and related concepts. Results improve as background indexing completes.",
