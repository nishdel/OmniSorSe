...
public static class HelpCatalog
{
    ...
    [
        ...
        Topic(HelpTopicId.MediaIntelligence, "Media Intelligence", "Makes supported images, audio, and video searchable through the same local Search experience.",
            "Bounded image headers and EXIF, local OCR output, and metadata returned by explicitly available local media tools. A configured user-managed whisper.cpp runtime and local model can supply bounded speech transcripts; no visual-description provider ships with OpenSorSe.",
        ...
        Topic(HelpTopicId.ContentIntelligence, "Content Intelligence", "Derives a small explainable set of local topics, textual entities, and an extractive summary from content OpenSorSe has already indexed.",
