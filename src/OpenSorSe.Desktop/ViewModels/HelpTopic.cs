...
public static class HelpCatalog
{
    ...
    [
        ...
        Topic(HelpTopicId.DuplicateView, "Duplicates", "Groups files with matching supported SHA-256 hashes and offers an explicitly reviewed safe-removal workflow.",
            ...
            ["Open Duplicates from Files.", "Select a group.", "Review every filename, path, size, and possible saving.", "Select only unwanted copies and leave at least one keeper.", "Request safe removal, review the Change Plan, then confirm execution.", "Use Undo while conflict checks still pass if a move was mistaken."],
            ["Back to Files", "Show in Files", "Open file", "Open folder", "Request safe removal", "Review Changes", "Undo"],
        ...
        Topic(HelpTopicId.SemanticSearch, "Search", "Hybrid Search finds known files using names, folder names, metadata, document text, OCR, tags, summaries, and related concepts. Results improve as background indexing completes.",
            ...
            ["Enable Search in Settings.", "Build or refresh the existing local index.", "Let background indexing add coverage gradually.", "Enter a natural-language or exact query.", "Review why each result matched.", "Optionally enable AI assistance to rerank only a bounded set of results already found by local Search.", "Pause, resume, retry, maintain, or rebuild when needed."],
            ...
            "An empty result is not definitive while coverage is incomplete. Deterministic Search works without Ollama; AI cannot introduce files Search did not find. Review diagnostics before exporting them.", [HelpTopicId.Results, HelpTopicId.Settings, HelpTopicId.AiSetup]),
        ...
        Topic(HelpTopicId.Settings, "Settings", "Controls local file-analysis preferences, optional AI assistance, and other persisted OpenSorSe settings.",
            ...
            ["Choose local file-analysis and indexing options.", "For scanned PDFs, install Tesseract plus eng/deu language data, enable OCR, and recheck capability.", "Enable AI assistance only if wanted.", "Review whether the configured endpoint is local or remote.", "Discover and select an installed model.", "Save or discard changes."],
            ["Extract searchable content", "Store Search index locally", "Enable AI assistance", "Ollama-compatible endpoint", "Discover models", "Show advanced features", "Save", "Discard changes", "Restore defaults"],
        ...
        Topic(HelpTopicId.RelatedFiles, "Related Files", "Discovers explainable connections between indexed documents, folders, topics, and metadata.",
            ...
            ["Let indexing build applicable evidence.", "Refresh Related Files.", "Select an item or collection.", "Inspect evidence for each connection.", "Confirm, reject, forget, or rebuild only when needed."],
            ["Refresh view", "Collections", "Related Files", "Evidence", "Confirm", "Reject", "Forget", "Rebuild"],
            ...
            "Every displayed connection is derived from stored evidence. Advanced architecture documentation calls this the Knowledge Graph.", [HelpTopicId.SemanticSearch, HelpTopicId.Privacy]),
        Topic(HelpTopicId.Privacy, "Privacy", "Explains what local indexing and optional AI can retain or transmit.",
            ...
            ["Review file-analysis and index settings.", "Inspect stored data for a file or source.", "Exclude sensitive folders or types when needed.", "Treat every non-loopback AI endpoint as remote.", "Review diagnostic exports before sharing."],
            ...
            "OpenSorSe has no telemetry or cloud dependency. A configured remote Ollama-compatible endpoint is outside that local boundary.", [HelpTopicId.Settings, HelpTopicId.AiSetup, HelpTopicId.Diagnostics]),
